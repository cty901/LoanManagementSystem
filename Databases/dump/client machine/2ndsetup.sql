...
INSERT INTO `branch` VALUES ('1','BRA0001','ballapana','0113022707','test@gmail.com',1,NULL,NULL,NULL,NULL);
...
CREATE TABLE `customer` (
  ...
  `INSERT_DATETIME` datetime DEFAULT NULL,
  `UPDATE_DATETIME` datetime DEFAULT NULL,
  `FK_AREA_ID` varchar(32) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `fk_customer_area1_idx` (`FK_AREA_ID`),
  CONSTRAINT `fk_customer_area1` FOREIGN KEY (`FK_AREA_ID`) REFERENCES `area` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `employee` VALUES ('01635767333650116258','CUS00001','nic','873083748v','Amila','Galappaththi','1987-01-01 00:00:00','male','Sri Lankan','Buddhism','single','Ballapana,Divulapitiya','amilavirajcbsl@gmail.com','0774461890',NULL,'0113022707','admin','amila','0774461890','?',NULL,0,1,NULL,NULL,NULL,NULL);
...
CREATE TABLE `employee_cash` (
  ...
  `TYPE` set('borrow','return') DEFAULT NULL,
...
CREATE TABLE `payment` (
  ...
  `INSERT_DATETIME` datetime DEFAULT NULL,
  `UPDATE_DATETIME` datetime DEFAULT NULL,
  `FK_LOAN_ID` varchar(32) NOT NULL,
  PRIMARY KEY (`ID`,`FK_LOAN_ID`),
  KEY `fk_payment_loan1_idx` (`FK_LOAN_ID`),
  CONSTRAINT `fk_payment_loan1` FOREIGN KEY (`FK_LOAN_ID`) REFERENCES `loan` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sms` (
  ...
  `TYPE` set('send','receive') DEFAULT NULL,
...
-- Dump completed on 2015-09-16 14:05:57
